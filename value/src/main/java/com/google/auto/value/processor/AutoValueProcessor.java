...
public class AutoValueProcessor extends AutoValueOrOneOfProcessor {
  ...
  public Set<String> getSupportedOptions() {
    AutoValueExtension.IncrementalExtensionType incrementalType = extensions.stream()
    ...
    switch (incrementalType) {
      case ISOLATING:
        return ImmutableSet.of(OMIT_IDENTIFIERS_OPTION, IncrementalAnnotationProcessorType.ISOLATING.getProcessorOption());
      case AGGREGATING:
        return ImmutableSet.of(OMIT_IDENTIFIERS_OPTION, IncrementalAnnotationProcessorType.AGGREGATING.getProcessorOption());
      case UNKNOWN:
