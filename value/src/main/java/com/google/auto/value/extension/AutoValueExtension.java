 ...
 *
 * <p>An Extension can extend the AutoValue implementation by generating a subclass of the AutoValue
 * generated class. It is not guaranteed that an Extension's generated class will be the final class
 * in the inheritance hierarchy, unless its {@link #mustBeFinal(Context)} method returns true. Only
