  ...
  public void notNullOnOuterClassWithNullableInnerType() {
    ...
    JavaFileObject expectedOutput =
        JavaFileObjects.forSourceLines(
            ...
            "final class AutoValue_Baz extends Baz {",
            "",
            "  private final Baz.Outer.@Baz.Nullable Inner inner;",
            "",
            "  private AutoValue_Baz(",
            "      Baz.Outer.@Baz.Nullable Inner inner) {",
            "    this.inner = inner;",
            "  }",
            "",
            "  @Override",
            "  public Baz.Outer.@Baz.Nullable Inner inner() {",
            "    return inner;",
            "  }",
            "",
            "  @Override",
            ...
            "",
            "  static final class Builder extends Baz.Builder {",
            "    private Baz.Outer.@Baz.Nullable Inner inner;",
            "    Builder() {",
            "    }",
            "    @Override",
            "    public Baz.Builder setInner(Baz.Outer.@Baz.Nullable Inner inner) {",
            "      this.inner = inner;",
            "      return this;",
            "    }",
            "    @Override",
