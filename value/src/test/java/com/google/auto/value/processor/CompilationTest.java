...
public class CompilationTest {
  ...
  @Test
  public void builderClassExtendsParameterizedBaseClass() {
    JavaFileObject baseClassObject = JavaFileObjects.forSourceLines(
        "foo.bar.BaseClass",
        "package foo.bar;",
        "",
        ...
        "}");
    JavaFileObject extendedClassObject = JavaFileObjects.forSourceLines(
        "foo.bar.ExtendedClass",
        "package foo.bar;",
        "import com.google.auto.value.AutoValue;",
        "",
        "@AutoValue",
        "public abstract class ExtendedClass extends BaseClass<Integer> {",
        "",
        "  @AutoValue.Builder",
        "  public static abstract class Builder {",
        "    public abstract Builder value(Integer value);",
        "    public abstract ExtendedClass build();",
        "  }",
        "}");
  ...
  @Test
  public void builderClassExtendsParameterizedBaseClassWithBuilder() {
    JavaFileObject baseClassObject = JavaFileObjects.forSourceLines(
        "foo.bar.BaseClass",
        "package foo.bar;",
        "",
        ...
        "  public abstract T value();",
        "",
        "  public static abstract class Builder<BUILDER extends Builder<BUILDER, T>, T> {",
        "    public abstract T value();",
        "    public abstract BUILDER value(T value);",
        "  }",
        "}");
    JavaFileObject extendedClassObject = JavaFileObjects.forSourceLines(
        "foo.bar.ExtendedClass",
        ...
        "",
        "  @AutoValue.Builder",
        "  public static abstract class Builder extends BaseClass.Builder<Builder, Integer> {",
        "    public abstract ExtendedClass build();",
        "  }",
        "}");
