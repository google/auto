...
/**
 * A package-less value type that uses a factory for construction.
 *
 * @see PackagelessValueTypeTest
 * @author emcmanus@google.com (Éamonn McManus)
 */
@AutoValue
public abstract class PackagelessValueTypeWithFactory {
  /**
  ...
  public static PackagelessValueTypeWithFactory
   ...
   */
  interface Factory {
    PackagelessValueTypeWithFactory create(String string, int integer, Map<String, Long> map);
  }
}
